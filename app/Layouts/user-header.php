...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="buy-prescription.php">
      ...
      <li class="nav-item">
        <a class="mx-auto nav-link collapsed" href="my-order.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="call-an-ambulance.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="medical-history.php">
