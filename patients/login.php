...
<head>
  ...
  <title>Login - CALL MY DOCTOR</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    ?>
                    <h5 class="card-title text-center pb-0 fs-4">Patient's Account</h5>
                  ...
                  <form class="row g-3 needs-validation" action="../Controllers/userCtrl.php" method="post" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="login_patient" type="submit">Login</button>
